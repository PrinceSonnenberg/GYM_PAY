...
type ModalType = 'theme' | 'profile' | 'payout' | 'notifications' | 'invoiceDefaults' | 'taxRate' | 'services' | 'exportData' | 'logout' | null;

const SettingsPage: React.FC = () => {
    const { settings, services, addServicePreset, updateServicePreset, deleteServicePreset, updateProfile, updatePayout, updateNotifications, updateUiTheme, updateInvoiceDefaults, resetAllData, clients, invoices, expenses } = useData();
